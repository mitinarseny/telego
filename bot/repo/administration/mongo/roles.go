...
func (r *RolesRepo) Create(ctx context.Context, roles ...*administration.Role) ([]*administration.Role, error) {
...
func (r *RolesRepo) CreateIfNotExists(ctx context.Context, roles ...*administration.Role) ([]*administration.Role, error) {
...
func (r *RolesRepo) GetAll(ctx context.Context) ([]*administration.Role, error) {
...
func (r *RolesRepo) GetByName(ctx context.Context, name string) (*administration.Role, error) {
...
func (r *RolesRepo) GetByNames(ctx context.Context, names ...string) ([]*administration.Role, error) {
    cursor, err := r.this.Find(ctx, bson.D{
        {"_id", bson.D{
            {"$in", names},
        }},
    ...
    roles := make([]*administration.Role, 0, len(names))
    if err := cursor.All(ctx, &roles); err != nil {
        return nil, err
    }
    return roles, nil
...
func (r *RolesRepo) AddScopes(ctx context.Context, scopes []administration.Scope, names ...string) ([]*administration.Role, error) {
...
func (r *RolesRepo) SetScopes(ctx context.Context, scopes []administration.Scope, names ...string) ([]*administration.Role, error) {
    res, err := r.this.UpdateMany(ctx, bson.D{
        {"_id", bson.D{
            {"$in", names},
        }},
